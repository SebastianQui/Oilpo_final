                        ...
                        <div class="modal-body">
                            ...
                            @csrf
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('Productocerrar') }}" type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar
                                ...
                                <tbody>
                                    @foreach ($servicios as $servicio)
                                        <tr>
                                            ...
                                            <td>
                                                <form class="borrar" action="{{ route('servicios.destroy',$servicio->id) }}" method="POST">
