                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="number" class="form-control" name="Precios" id="Precios" aria-describedby="helpId" placeholder="">
                            <small id="helpId" class="form-text text-muted"></small>
    ...
    <script>
        ...
        function agregar(){
            ...
            if(producto !="" && cantidad >0 && precio>0){
                ...
                var fila = '<tr class="selected" id="fila'+cont+'"><td><input type="text" name="Producto[]" value="'+producto+'"></td><td><input type="number" name="Cantidad[]" value="'+cantidad+'"></td><td><input type="number" name="Precio[]" value="'+precio+'"></td><td>'+subtotal[cont]+'</td><td><button class="btn btn-danger" onclick="eliminar('+cont+');" >X</button></td></tr>';
                cont++;
                limpiar();
