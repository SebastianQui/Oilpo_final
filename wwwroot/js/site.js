    ...
    $(function () {
        ...
        $("#Search").autocomplete({
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        response($.map(data, function (item) {
                            return { label: item.name, value: item.price, id:item.id };
                        }));
                    },
            ...
            select: function (event, ui) {
                ...
                var productItem = '<tr>  + <td>' + ui.item.label + '</td><td class="price">' + ui.item.value + '</td><td>' + '<input  class="qunatity" type= "number" min= "1" step= "1" value= "1"  max="99" />' + '</td><td class="amount">' + ui.item.value + '</td><td><a data-itemId="' + ui.item.id + '" href="#" class="deleteItem"><i class="fa fa-trash"></i></a></td></tr>';
    ...
    $("#BtnSave").click(function (e) {
        ...
        if (submitValidation()) {
            ...
            $.each($("#detailsTable tbody tr"), function () {
                orderArr.push({
                    ProductId: $(this).find('.deleteItem').attr('data-itemId'),
